...
void _env_setLongTermContext(void);
void _env_setShortTermContext(void);
void _env_setContext(char* fileName, Arguments* args);
...
Arguments* env_retrieveStoredArgs(void) {
    ...
    _env_setShortTermContext();
    _env_setLongTermContext();
...
void _env_setLongTermContext(void) {
    ...
    _env_setContext(".xctrc-long", long_term_args);
...
void _env_setShortTermContext(void) {
    ...
    _env_setContext(".xctrc-short", short_term_args);
